class Game_mode():
    def __init__(self, name=("Имя мода", "Mode Name"), index=None, min_rep_stars=0, min_golds=0, level=0,
                 step_time="unlim",
                 coef_award=1.0):
        self.name = name
        self.index = index
...
mode_60s = Game_mode(index=2, name=["40 секунд на ход", "40 seconds for 1 turn"], level=4, step_time=40,
                     coef_award=1.25)
