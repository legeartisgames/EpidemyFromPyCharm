...
Инвестиции в производство бесконечно.\n - Там, куда попали больные, дополнительно заболевает '+str(common_data.my_game.parameters_of_tech[24][2][1][0]*100)+'% от числа попавших больных
...
td = {
  ...
  "transfer_c": ["Коэффициент переноса", "Transfer coefficient"],
