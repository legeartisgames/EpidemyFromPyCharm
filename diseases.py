...
class Disease():
    def __init__(self, level, z = 2, d = 0.1, name = ["Болезнь", "Disease"], min_stars=0, min_golds=0, index = 0, rod = 0, 
                 s_coins = 15, s_date = [1, 1, 2020], z_outs = [1.45, 1.5, 1.3, 0.9, 0.6, 0.55, 0.5, 0.5, 0.9, 1.3, 1.35, 1.4],
                 c_coef_perenos = 1, c_points = 1, im_term = 6, s_im_level = 0, pad = ["O"]*6, s_name =  "disease]",
                 min_gold=0):
        self.z = z
        self.d = d
        self.name = name
        ...
        self.c_coef_perenos = c_coef_perenos
...
ospa_padezhi = ["натуральная оспа", "натуральной оспы", "натуральной оспе", "натуральную оспу", "натуральной оспой", "натуральной оспе"]
...
flu_disease = Disease(z = 3.2, d = 0.002, im_term = 2, s_im_level = 0.1, 
                      ...
                      c_coef_perenos = 2, c_points = 1, pad = grip_padezhi, min_gold = 165)
...
chuma_disease = Disease(z = 2.3, d = 0.9, im_term = 120, s_im_level = 0.02, 
                        ...
                        z_outs=[0.6, 0.6, 0.9, 1.1, 1.2, 1.35, 1.45, 1.45, 1.2, 1, 0.9, 0.7], s_date = [1, now_month, now_year],
