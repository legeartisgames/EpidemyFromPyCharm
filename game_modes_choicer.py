...
class Mode_choiser_layout(FloatLayout):
    ...
    def open_layout(self, instance):
        ...
        self.lab_choose = uix_classes.Label_with_tr(text_source=["Выберите режим игры:", 
                                      ...
                                      font_size = (sizes.Width_of_screen/50), halign = 'left')
        ...
        self.checkbox = checkboxer.Universal_CheckBox(type = "mode", 
                                                      item_list = list_of_aval_modes, text_size = sizes.Width_of_screen/50,
                                                      size_hint = [.7, .8], pos_hint = {"center_x": .36,  'center_y': 0.45})
        self.add_widget(self.checkbox)   
        
        self.btn_confirm = uix_classes.Button_with_image(text_source = ["Начать игру!", "Start the game!"], size_hint_x = None, width = sizes.Width_of_screen/4.5, size_hint_y = .15, 
        ...
        self.btn_modes_info = uix_classes.Button_with_image(text_source = ["Информация\nо режимах", "Modes info"], size_hint_x = None, size_hint_y = .15, width = sizes.Width_of_screen / 4.5, 
