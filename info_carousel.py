...
sources = ['empty', '01_common_ill.jpg', '02_hex.jpg', '03_buttons.jpg', '04_methods.jpg', '05_multichoice.jpg', '06_choose.jpg', '07_vaccine.jpg', 'empty']
...
class InfoCarousel(Carousel):
    ...
    def create(self):
        ...
        for i in range(9):
            ...
            if common_var.lang == 0:
                ...
                titles = titles_en
                src = src_en
            lab_title = Label(text = titles[i], size_hint_y = .08, font_size = sizes.Width_of_screen/45)
            if i > 0 and i < 8:
                ...
                image = Label(text = rules_strings[common_var.lang], 
                          font_size = sizes.Width_of_screen/45, markup = True, size_hint_y = .92)
                ...
                image = Label(text = rules_strings[common_var.lang], 
                          font_size = sizes.Width_of_screen/50, markup = True, size_hint_y = .92)
                image.bind(on_ref_press = lambda *args: web_goer.go_to_link(*args))
                
            bl = BoxLayout(orientation = 'vertical', padding = sizes.Width_of_screen/50, spacing = sizes.Width_of_screen/100)
    ...
    def on_up(self, instance, touch):
        ...
        if touch.is_double_tap == True:
            ...
            if touch.pos[0]>sizes.Width_of_screen/2:
                if self.index == 8:
